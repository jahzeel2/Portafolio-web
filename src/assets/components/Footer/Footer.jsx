      ...
      <div className='container'>
        <div className='sm:flex items-center justify-between md:gap-8'>
          <div className='w-full sm:w-1/2'>
            ...
            <h2 className='text-[26px] leading-10 mb-6 text-white font-[600] md:text-[2rem]'>
            ¿Quieres darnos una oportunidad?
            </h2>
            <a href='#contact'>
          ...
          <div className='w-full sm:w-1/2'>
            ...
            <p className='text-gray-300 leading-7 mt-4 sm:mt-0 text-[20px]'>
            "Todos los grandes desarrolladores que conoces llegaron ahí resolviendo problemas para los que no estaban calificados hasta que realmente lo hicieron".
            </p>
            ...
            <div className='flex items-center gap-4 flex-wrap md:gap-8'>
              ...
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://www.instagram.com/jahzeelabraham/' className='text-gray-font-[500] text-[25px]'><i class="ri-instagram-line"></i></a>
              </span>
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://github.com/jahzeel2/Jahzeel-presentacion' className='text-gray-300 font-[500] text-[25px]'><i class='ri-github-line'></i></a>
              </span>
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://www.linkedin.com/in/jahzeel-abraham-28a893267/' className='text-gray-300 font-[500] text-[25px]'><i class="ri-linkedlin-box-line"></i></a>
              </span>
            </div>
          </div>
        </div>
            ...
            <div className='hidden sm:block'>
              <div className='flex items-center gap-[10px]'>
                ...
                <div className='leading-[20px]'>
                  <h2 className='text-xl text-white font-[700]'>Youth Code</h2>
                </div>
              </div>
            </div>
            <div>
              <p className='text-gray-400 text-[14px]'>Copyright &copy; {year} <br /><b>Youth Code</b> </p>
            </div>
          </div>
        </div>
      </div>
