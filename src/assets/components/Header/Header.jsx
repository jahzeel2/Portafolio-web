        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex itmes-center gap-[10px]'>
            ...
            <div className='leading-[20px]'>
              <h2 className='text-xl text-white font-[700]'>Jahzeel Abraham</h2>
          ...
          <div className='menu'ref={menuRef} onClick={toggleMenu}>
            <ul className='flex  items-center gap-10'>
              <li className='text-white font-[600]'><a href='#about'>Acerca </a></li>
              <li className='text-white font-[600]'><a href='#services'>Servicios</a></li>
              <li className='text-white font-[600]'><a href='#portfolio'>Portfolio</a></li>
              <li className='text-white font-[600]'><a href='#contact'>Contacto</a></li>
            </ul>
          </div>
          {/* menu end */}
          ...
          <div className='flex items-center gap-4'>
            ...
            hover:font-[500] ease-in duration-200'><i class="ri-mail-download-line"></i>Curriculum</button></a>
